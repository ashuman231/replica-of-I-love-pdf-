...
<div class="tool">
	...
	<form action="/webapp/extract" method="post" enctype="multipart/form-data">
  <input class="uploader__btn tooltip--left" type="file" name="userfile" required/><br><br><strong>${message}</strong><br><br>

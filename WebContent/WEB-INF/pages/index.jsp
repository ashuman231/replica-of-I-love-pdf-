...
<div class="tools">
    <div class="tools__container">
        <div class="tools__item">
            <a href="/webapp/mergePage" title="Merge PDF">
        ...
        <div class="tools__item">
            <a href="/webapp/splitPage" title="Split PDF">
                <div class="tools__item__icon">
        ...
        <div class="tools__item">
            <a href="/webapp/imagePage" title="PDF to JPG">
                <div class="tools__item__icon">
       ...
       <br/>
        ...
        <div class="tools__item">
            <a href="/webapp/unlockPage" title="Unlock PDF">
                <div class="tools__item__icon">
        ...
        <div class="tools__item">
            <a href="/webapp/protectPage" title="Protect PDF">
                <div class="tools__item__icon">
        ...
        <div class="tools__item">
            <a href="/webapp/textPage" title="convert to text">
                <div class="tools__item__icon">
